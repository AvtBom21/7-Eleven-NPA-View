...
var DIRECTOR_VIEW_ALIAS_MAP = {
  ...
  "Supplier's profile": ["Supplier's profile", 'Supplier Profile', 'Supplier profile'],
...
var DIRECTOR_MOBILE_FIELD_ALIASES = {
  ...
  supplierProfile: ["Supplier's profile", 'Supplier Profile', 'Supplier profile'],
...
function _directorMobileBuildProduct_(row, rowNumber, colMap) {
  ...
  return {
    ...
    supplierProfile: _directorMobileGetValue_(row, colMap, 'supplierProfile'),
